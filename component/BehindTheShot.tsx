  ...
  return (
    <section id="process" className="section-pad bg-[#0a0a0a] overflow-hidden">
      <div className="page-container">
        ...
        <SectionLabel className="font-syne text-[8px] tracking-[0.35em] uppercase text-white/20 mb-4 md:hidden">
          Swipe to explore →
        </SectionLabel>
                  ...
                  <div className="space-y-4 sm:space-y-5">
                    <FadeReveal delay={0.05}>
                      <div className="flex items-center gap-3">
                        <span className="material-symbols-outlined text-brand-accent text-base">
                          {icon}
                        </span>
                    ...
                    <WordRevealHeading
                      className="font-syne text-xl sm:text-2xl md:text-3xl font-bold text-white"
                      start="top 92%"
                    >
                      {title}
                    </WordRevealHeading>
